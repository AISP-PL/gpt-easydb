...
def AddFileLogger(logfile_file: str,
                  logfile_log_level: str = 'warning',
                  logfile_log_color: bool = False,
                  log_line_template: str = log_template1,
                  filemode: str = 'w'):
...
def AddConsoleLogger(console_log_output: str,
...
def loggingSetup(console_log_output: str = 'stdout', console_log_level: str = 'info', console_log_color: bool = True, console_log_enabled: bool = True,
                 logfile_file: str = '', logfile_log_level: str = 'info', logfile_log_color: bool = False, logfile_size: int = 25, logfile_enabled: bool = True,
                 log_line_template: str = log_template1):
    ...
    if (logfile_enabled):
        try:
            logfile_handler = logging.handlers.RotatingFileHandler(
                logfile_file, mode='w', maxBytes=logfile_size*1024*1024, backupCount=2)
        except Exception as exception:
            print('Failed to set up log file: %s' % str(exception))
            return False
